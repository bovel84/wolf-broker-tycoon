...
bottom_nav = """<nav class="bottom-nav" id="bottomNav"><button onclick="wolfSwitchView('dashboard')" class="active">\U0001f4ca<span class="bn-label">Dashboard</span></button><button onclick="wolfSwitchView('market')">\U0001f4c8<span class="bn-label">Mercato</span></button><button onclick="wolfSwitchView('portfolio')">\U0001f4bc<span class="bn-label">Portafoglio</span></button><button onclick="wolfSwitchView('assembly')">\U0001f3db\ufe0f<span class="bn-label">Assemblee</span></button><button onclick="toggleMobileMoreMenu()">\u22ee<span class="bn-label">Altro</span></button></nav><div id="mobileMoreMenu"><button class="btn" style="display:block;width:100%;text-align:left;margin-bottom:6px;min-height:44px" onclick="wolfSwitchView('news');toggleMobileMoreMenu()">\U0001f4f0 Notizie</button><button class="btn" style="display:block;width:100%;text-align:left;margin-bottom:6px;min-height:44px" onclick="wolfSwitchView('transactions');toggleMobileMoreMenu()">\U0001f4cb Transazioni</button><button class="btn" style="display:block;width:100%;text-align:left;margin-bottom:6px;min-height:44px" onclick="wolfSwitchView('career');toggleMobileMoreMenu()">\U0001f3af Carriera</button><button class="btn" style="display:block;width:100%;text-align:left;min-height:44px" onclick="wolfSwitchView('save');toggleMobileMoreMenu()">\U0001f4be Salvataggio</button><button class="btn" style="display:block;width:100%;text-align:left;min-height:44px" onclick="wolfSwitchView('settings');toggleMobileMoreMenu()">\u2699\ufe0f Impostazioni</button></div>"""
...
var _origAdvance=(typeof advanceWeek==='function')?advanceWeek:function(){};
if(typeof advanceWeek!=='undefined'){window.advanceWeek=function(){_origAdvance();if(window._competitorEngine){try{window._competitorEngine.processWeek()}catch(e){}}if(typeof LLMNewsEngine!=='undefined'&&LLMNewsEngine.processNewsTurn){var gs={week:(typeof week!=='undefined')?week:1,cash:(typeof cash!=='undefined')?cash:10000,level:(typeof level!=='undefined')?level:1,portfolio:(typeof portfolio!=='undefined')?portfolio:{},companies:(typeof companies!=='undefined')?companies:[]};LLMNewsEngine.processNewsTurn(gs).then(function(r){if(r&&r.length>0&&typeof addNews==='function'){r.forEach(function(n){addNews(n.title,n.impact,n.content)})}}).catch(function(){})}}}
"""
