...
(function (global) {
  ...
  function buildWorldPrompt(context) {
    ...
    return 'Simula una settimana coerente di un ecosistema finanziario mondiale persistente. ' +
      ...
      'Tieni conto di quote possedute e offerte, potere di voto, campagne assembleari, richieste del capo, fiducia, favori, rivalita e memoria dei colleghi. Le interazioni devono rispettare numeri, scadenze e rapporti già presenti. ' +
